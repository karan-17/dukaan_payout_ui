    ...
    return (
        ...
        `}
            ...
            <Flex w="192px" alignItems="center" gap="12px">
                ...
                <Box alignSelf="stretch" w="108px" cursor={"pointer"}>
                    <Text
                        fontSize="15px"
                        fontStyle="normal"
                        fontWeight="500"
            ...
            <Box mt="8px" color="white" h="92.2%" as='button'>
                <Flex
                    w="208px"
                    p="8px 16px"
                    ...
                    >
                        <g opacity="0.8">
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M0.835938 3.03633C0.835938 2.65167 1.14641 2.33984 1.52939 2.33984H13.0838C13.4668 2.33984 13.7772 2.65167 13.7772 3.03633V13.094C13.7772 13.4787 13.4668 13.7905 13.0838 13.7905H1.52939C1.14641 13.7905 0.835938 13.4787 0.835938 13.094V3.03633ZM2.22284 3.73282V12.3975H12.3903V3.73282H2.22284Z"
                                fill="white"
                            />
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M12.3903 6.90469C12.3903 6.52003 12.7008 6.2082 13.0838 6.2082H16.1649C16.3489 6.2082 16.5252 6.28158 16.6553 6.4122L18.9662 8.7332C19.0962 8.86381 19.1693 9.04097 19.1693 9.22569V13.094C19.1693 13.4787 18.8588 13.7905 18.4758 13.7905L13.0838 13.7905C12.7008 13.7905 12.3903 13.4787 12.3903 13.094V6.90469ZM13.7772 7.60118V12.3975H17.7824V9.51419L15.8777 7.60118H13.7772Z"
                                fill="white"
                            />
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M4.99566 13.7905C4.31509 13.7905 3.76338 14.3446 3.76338 15.0281C3.76338 15.7117 4.31509 16.2658 4.99566 16.2658C5.67623 16.2658 6.22794 15.7117 6.22794 15.0281C6.22794 14.3446 5.67623 13.7905 4.99566 13.7905ZM2.37648 15.0281C2.37648 13.5753 3.54912 12.3975 4.99566 12.3975C6.4422 12.3975 7.61484 13.5753 7.61484 15.0281C7.61484 16.481 6.4422 17.6588 4.99566 17.6588C3.54912 17.6588 2.37648 16.481 2.37648 15.0281Z"
                                fill="white"
                            />
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M15.0095 13.7905C14.3289 13.7905 13.7772 14.3446 13.7772 15.0281C13.7772 15.7117 14.3289 16.2658 15.0095 16.2658C15.6901 16.2658 16.2418 15.7117 16.2418 15.0281C16.2418 14.3446 15.6901 13.7905 15.0095 13.7905ZM12.3903 15.0281C12.3903 13.5753 13.563 12.3975 15.0095 12.3975C16.456 12.3975 17.6287 13.5753 17.6287 15.0281C17.6287 16.481 16.456 17.6588 15.0095 17.6588C13.563 17.6588 12.3903 16.481 12.3903 15.0281Z"
                                fill="white"
                            />
                        </g>
                    </svg>
                    ...
                    >
                        <g opacity="0.8">
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M2.66406 10.9371C2.66406 10.5091 3.01104 10.1621 3.43906 10.1621H7.81406C8.24208 10.1621 8.58906 10.5091 8.58906 10.9371C8.58906 11.3651 8.24208 11.7121 7.81406 11.7121H4.21406V16.5621C4.21406 16.9901 3.86708 17.3371 3.43906 17.3371C3.01104 17.3371 2.66406 16.9901 2.66406 16.5621V10.9371Z"
                                fill="white"
                            />
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M1.41406 16.5621C1.41406 16.1341 1.76104 15.7871 2.18906 15.7871H17.8141C18.2421 15.7871 18.5891 16.1341 18.5891 16.5621C18.5891 16.9901 18.2421 17.3371 17.8141 17.3371H2.18906C1.76104 17.3371 1.41406 16.9901 1.41406 16.5621Z"
                                fill="white"
                            />
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M7.03906 7.18711C7.03906 6.75909 7.38604 6.41211 7.81406 6.41211H12.1891C12.6171 6.41211 12.9641 6.75909 12.9641 7.18711C12.9641 7.61513 12.6171 7.96211 12.1891 7.96211H8.58906V16.5621C8.58906 16.9901 8.24208 17.3371 7.81406 17.3371C7.38604 17.3371 7.03906 16.9901 7.03906 16.5621V7.18711Z"
                                fill="white"
                            />
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M11.4141 3.43711C11.4141 3.00909 11.761 2.66211 12.1891 2.66211H16.5641C16.9921 2.66211 17.3391 3.00909 17.3391 3.43711V16.5621C17.3391 16.9901 16.9921 17.3371 16.5641 17.3371H12.1891C11.761 17.3371 11.4141 16.9901 11.4141 16.5621V3.43711ZM12.9641 4.21211V15.7871H15.7891V4.21211H12.9641Z"
                                fill="white"
                            />
                        </g>
                    </svg>
                ...
                >
                    <svg
                        ...
                        fill="none"
                    >
                        <g opacity="0.8" clip-path="url(#clip0_84539_2393)">
                            <path
                ...
                >
                    <svg
                        ...
                        fill="none"
                    >
                        <g opacity="0.8" clip-path="url(#clip0_84539_2403)">
                            <path
            ...
            >
                ...
                <Flex as='button' flexDirection="column" alignItems="flex-start" gap="2px">
                    <Text
                        fontSize="13px"
                        fontStyle="normal"
                        fontWeight="400"
