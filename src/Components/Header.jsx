...
const Header = () => {
    return (
        <Flex
            ...
            width={"100%"}
            backgroundColor={"var(--Black-100, #FFF)"}
            padding={"12px 32px"}
            align={"center"}
            gap={"16px"}
            flex={"1 0 0"}
                ...
                <Flex align={"center"} gap={"6px"}>
                    <Box width={"14px"} height={"14px"}>
                        <svg
                            ...
                            fill="none"
                        >
                            <g clip-path="url(#clip0_84843_4426)">
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
            ...
            >
                <Box width={"16px"} height={"16px"}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <g clip-path="url(#clip0_84843_4430)">
