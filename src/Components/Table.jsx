    ...
    const TableArr = [
        {
            ...
            amount: method === 'payout' ? '₹10,125.00' : '₹1,125.00',
        },
        {
            id: '#281209',
            status: 'Processing',
                                        ...
                                        <Td>
                                            <Flex alignItems="center" gap="5px">
                                                <svg
                                                    ...
                                                    fill="none"
                                                >
                                                    <circle cx="5.66406" cy="5" r="5" fill={ele.status === 'Successful' ? "#17B31B" : "#999999"} />
                                                </svg>
                                                {ele.status}
                                            </Flex>
                                        </Td>
                                        <Td>{ele.transactionId}</Td>
                                        {method === "refund" && <Td >{ele.refundDate}</Td>}
                                        {method === "payout" && <Td >{ele.amount}</Td>}
